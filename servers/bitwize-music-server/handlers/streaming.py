"""Streaming URL management and skills listing tools."""
...
# ---------------------------------------------------------------------------
# Skills listing tools
#
# These are grouped here (rather than in a core module) because they query
# reference/skills data, which is conceptually similar to reference lookups.
# ---------------------------------------------------------------------------
...
def register(mcp):
    """Register streaming URL and skills tools with the MCP server."""
